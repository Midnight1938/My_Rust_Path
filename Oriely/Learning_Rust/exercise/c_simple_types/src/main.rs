...
fn main() {
    ...
    //
    ding_machine::print_difference(coords.0, coords.1); // The . operator accesses the first and second elements of the tuple
    ...
    // "Ding, you found 13!"
    //
    ding_machine::ding(series[6]); // the [] is different from the . operator, [] is for arrays
    ...
    //
    ding_machine::on_off(mess.2[1].0); // . is different from []! [] is for arrays, . is for structs and tuples
